...
class BooksTest extends TestCase
{
    ...
    public function testGetBookDetailNonexistentID() : void
    {
        $request = HelperFactory::createRequest('GET', '/books/10');
        $response = $this->app->handle($request);
        $this->assertEquals(StatusCodeInterface::STATUS_NOT_FOUND, $response->getStatusCode(), self::RESULT_CHAR_FAILED .'Test GET books/:id failed. Invalid response code.');
    }
    public function testGetBookDetailInvalidID() : void
    {
        $request = HelperFactory::createRequest('GET', '/books/5abc');
        $response = $this->app->handle($request);
        $this->assertEquals(StatusCodeInterface::STATUS_BAD_REQUEST, $response->getStatusCode(), self::RESULT_CHAR_FAILED .'Test GET books/:id failed. Invalid response code.');
    }
    ...
    public function testFailingPostBookUnauthorized() : void
    {
        $newBook = [
            'name' => "BI-PHP Proč studenti rádí dělají úkoly?",
            'author' => "Andrii Plyskach",
        ...
        $request = $request->withParsedBody($newBook);
        $response = $this->app->handle($request);
        $this->assertEquals(StatusCodeInterface::STATUS_UNAUTHORIZED, $response->getStatusCode(), self::RESULT_CHAR_FAILED .'Test POST /books failed. Invalid status code.');
    }
    public function testFailingPostBookInvalidAuth() : void
    {
        $newBook = [
            'name' => "BI-PHP Proč studenti rádí dělají úkoly?",
            'author' => "Andrii Plyskach",
        ...
        $headers = [
            'HTTP_ACCEPT' => 'application/json',
            'Authorization' => base64_encode('admin:heslo')
        ];
        $request = HelperFactory::createRequest(
            method: 'POST',
            path:'/books',
    ...
    public function testFailingPostBookInvalidBody() : void
    {
        $newBook = [
            'name' => "BI-PHP Proč studenti rádí dělají úkoly?",
            'author' => "Andrii Plyskach",
            'publishING' => "Vydavatelství svátý oříšek",
            'isbn' => "1-84356-888-3",
            'pages' => 188
        ];
        $headers = [
        ...
        $request = $request->withParsedBody($newBook);
        $response = $this->app->handle($request);
        $this->assertEquals(StatusCodeInterface::STATUS_BAD_REQUEST, $response->getStatusCode(), self::RESULT_CHAR_FAILED .'Test POST /books failed. Invalid status code.');
    }
    ...
    public function testFailingPutBookInvalidID() : void
    {
        $newBook = [
            'name' => "Sestavení rozvrhu není jednoduché",
            'author' => "Daniel Domek",
        ...
        $request = $request->withParsedBody($newBook);
        $response = $this->app->handle($request);
        $this->assertEquals(StatusCodeInterface::STATUS_BAD_REQUEST, $response->getStatusCode(), self::RESULT_CHAR_FAILED .'Test PUT books/:id failed');
    }
    public function testFailingPutBookNonExistentID() : void
    {
        $newBook = [
            'name' => "Sestavení rozvrhu není jednoduché",
            'author' => "Daniel Domek",
        ...
        $request = $request->withParsedBody($newBook);
        $response = $this->app->handle($request);
        $this->assertEquals(StatusCodeInterface::STATUS_NOT_FOUND, $response->getStatusCode(), self::RESULT_CHAR_FAILED .'Test PUT books/:id failed');
    }
    public function testFailingPutBookInvalidBody() : void
    {
        $newBook = [
            'name' => "Sestavení rozvrhu není jednoduché",
            'author' => "Daniel Domek",
    ...
    public function testFailingDeleteNonExistentID(): void
    {
        $headers = ['HTTP_ACCEPT' => 'application/json', 'Authorization' => $this->getAuth()];
        $request = HelperFactory::createRequest(
            method: 'DELETE',
        ...
        $response = $this->app->handle($request);
        $this->assertEquals(StatusCodeInterface::STATUS_NOT_FOUND, $response->getStatusCode(), self::RESULT_CHAR_FAILED .'Test DELETE books/:id failed');
    }

    public function testFailingDeleteInvalidID(): void
    {
        $headers = ['HTTP_ACCEPT' => 'application/json', 'Authorization' => $this->getAuth()];
        $request = HelperFactory::createRequest(
            method: 'DELETE',
        ...
        $response = $this->app->handle($request);
        $this->assertEquals(StatusCodeInterface::STATUS_BAD_REQUEST, $response->getStatusCode(), self::RESULT_CHAR_FAILED .'Test DELETE books/:id failed');
    }

    public function testFailingDeleteNotAuthenticated(): void
    {
        ...
        $response = $this->app->handle($request);
        $this->assertEquals(StatusCodeInterface::STATUS_UNAUTHORIZED, $response->getStatusCode(), self::RESULT_CHAR_FAILED .'Test DELETE books/:id failed');
    }
